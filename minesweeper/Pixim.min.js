 ...
 * @license MIT
 */
var Pixim=function(t,i,e){"use strict";window.console.log("%c pixim.js%cv1.4.1 %c","color: #FFF; background: #03F; padding: 5px; border-radius:12px 0 0 12px; margin-top: 5px; margin-bottom: 5px;","color: #FFF; background: #F33; padding: 5px;  border-radius:0 12px 12px 0;","padding: 5px;");
/*!
